...
var forms = function forms() {
  ...
  var phoneInputs = document.querySelectorAll('input[name="user_phone"]'); // не працює регулярка на інпутах!!!
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener("click", function (e) {
        ...
        document.body.style.overflow = 'hidden'; // document.body.classList.add('modasl-open')
      });
    });
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  var heared = document.querySelector(headerSelector),
  ...
  hideTabContent();
  showTabContent();
  heared.addEventListener('click', function (e) {
    var target = e.target;
